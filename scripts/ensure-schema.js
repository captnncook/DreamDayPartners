...
const STATEMENTS = [
  ...
  `ALTER TABLE "vendors" ADD COLUMN IF NOT EXISTS "avgResponseMinutes" INTEGER`,
  `ALTER TABLE "vendors" ADD COLUMN IF NOT EXISTS "responseSampleCount" INTEGER NOT NULL DEFAULT 0`,

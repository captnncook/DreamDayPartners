...
async function PATCHImpl(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const {
    ...
    closingTime, soundLimit, setupTime, teardownTime, badWeatherPlan, outdoorSoundRule, isOfficialCeremonyLocation, outdoorCeremonyPossible,
  ...
  const updated = await prisma.vendor.update({
    ...
    data: {
      ...
      ...(setupTime !== undefined ? { setupTime: setupTime || null } : {}),
      ...(teardownTime !== undefined ? { teardownTime: teardownTime || null } : {}),
      ...(badWeatherPlan !== undefined ? { badWeatherPlan: badWeatherPlan || null } : {}),
      ...(outdoorSoundRule !== undefined ? { outdoorSoundRule: outdoorSoundRule || null } : {}),
